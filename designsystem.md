...
- **Primary**:
  - Bg: Green Primary (`bg-[#1baa56]`)
  - Hover Bg: Green Darker (`bg-[#148041]`)
  - Text: White, Bold
  - Shape: Full Rounded
  - Shadow: `shadow-lg shadow-[#1baa56]/30`
  - Animation: `hover:-translate-y-1 active:scale-95 transition-all duration-200`
- **Social/Outline**:
  - Bg: White
  - Border: Gray-200
  - Shape: Full Rounded
...
- **Input Fields**:
  ...
  - Border: Transparent (Default) -> Green Primary (`border-[#1baa56]/50`) (Hover/Group Focus)
  - Icon: Left-aligned, Gray-400 -> Green Primary (`text-[#1baa56]`) (Active)
...
- **Soft Glow**: `shadow-[#1baa56]/30` for primary actions.
